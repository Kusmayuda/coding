  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-file-text-o"></i>Post Task Content</h3>
            <ol class="breadcrumb">
          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <form class="form-horizontal " method="post" action="<?php base_url(); ?>/admin/post/uploadPost" enctype="multipart/form-data">
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Judul</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="judul" maxlength="19">
                    </div>
                  </div>
                  <?php
                    ...
                    <div class="col-sm-10">
                      <select id="matkul" name="matkul">
                        <?php foreach ($results as $option) { ?>
                          <option value="<?= $option['id']; ?>"><?= $option['matkul_nama']; ?></option>
                        <?php } ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <img src="<?= base_url('/'); ?>/img/thumbnail/avat.png" class="img-preview" style="width:20%;height:20%; display: block; margin-left: auto; margin-right: auto;">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <textarea cols=50 name="deskripsi" maxlength="170"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-2">Start Date</label>
                    <div class="col-sm-10">
                      <input name="startdate" id="dp1" type="text" value="<?php echo date('m-d-Y'); ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-2">End Date</label>
                    <div class="col-sm-10">
                      <input name="enddate" id="dp4" type="text" value="<?php echo date('m-d-Y'); ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
